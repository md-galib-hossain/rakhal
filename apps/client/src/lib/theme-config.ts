...
export const themeColors = {
  light: {
    ...
    gradient: "bg-gradient-to-b from-gray-50 to-white text-gray-800",
  ...
  dark: {
    ...
    gradient: "bg-gradient-to-b from-gray-900 to-gray-800 text-gray-100",
  ...
  purple: {
    ...
    gradient: "bg-gradient-to-b from-purple-700 to-purple-600 text-white",
  ...
  green: {
    ...
    gradient: "bg-gradient-to-b from-emerald-700 to-emerald-600 text-white",
  ...
  blue: {
    ...
    gradient: "bg-gradient-to-b from-sky-700 to-sky-600 text-white",
